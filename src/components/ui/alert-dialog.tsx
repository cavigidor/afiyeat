...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    <AlertDialogOverlay />
    {/* Same safe-area flex centering as dialog.tsx - see the note there.
        This one additionally had no height cap at all and a full-bleed
        w-full, so a confirmation with more than a couple of lines of body
        text (the delete-account one, for instance) ran off both the top
        and bottom of an iPhone screen with no way to scroll to the
        buttons. */}
